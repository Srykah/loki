...
# Lib prefixing
function(loki_add_lib_prefix target)
...
function(loki_create_lib)
  cmake_parse_arguments(LIB "INTERFACE" "NAME"
                        "HEADERS;INTERNAL_HEADERS;SOURCES;PRIVATE_DEPS;PUBLIC_DEPS;INTERFACE_DEPS" ${ARGN})
  ...
  target_include_directories(${LIB_NAME} INTERFACE $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}/src>
                                                   $<INSTALL_INTERFACE:${CMAKE_INSTALL_INCLUDEDIR}>)
  loki_add_lib_prefix(${LIB_NAME})
  loki_target_install_files(${LIB_NAME} FILES ${LIB_HEADERS} ${LIB_INTERNAL_HEADERS} All.hpp)
