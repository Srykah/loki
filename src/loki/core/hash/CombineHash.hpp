...
template <typename T>
std::size_t combineHash(const T& val) {
...
std::size_t combineHash(std::size_t seed) {
    return seed;
}
...
template <typename T>
std::size_t combineHash(std::size_t seed, const T& val) {
...
std::size_t combineHash(const S& val1, const T& val2) {
...
std::size_t combineHash(const S& val1, const T& val2, const Args& ... args) {
...
/// doesn't matter
template <typename... Args>
std::size_t combineHashSym(const Args&... args) {
 ...
 * std::size_t hash1 = combineHash(x, y, z, t);
 * std::size_t hash2 = combineHash(t, x, y, z);
 * std::size_t hashSym1 = combineHashSym(x, y, z, t);
 * std::size_t hashSym2 = combineHashSym(t, x, y, z);
 * \endcode
 *
