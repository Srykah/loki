...
#define LOKI_CORE_GET_MACRO(_1, _2, _3, _4, _5, _6, _7, _8, _9, macro, ...) macro
...
#define LOKI_CORE_REPEAT_4(macro, x1, x2, x3, x4) macro(x1) macro(x2) macro(x3) macro(x4)
#define LOKI_CORE_REPEAT_5(macro, x1, x2, x3, x4, x5) macro(x1) macro(x2) macro(x3) macro(x4) macro(x5)
#define LOKI_CORE_REPEAT_6(macro, x1, x2, x3, x4, x5, x6) LOKI_CORE_REPEAT_5(macro, x1, x2, x3, x4, x5) macro(x6)
...
#define LOKI_CORE_REPEAT(macro, ...)                                                                               \
  LOKI_CORE_GET_MACRO(__VA_ARGS__, LOKI_CORE_REPEAT_9, LOKI_CORE_REPEAT_8, LOKI_CORE_REPEAT_7, LOKI_CORE_REPEAT_6, \
                      LOKI_CORE_REPEAT_5, LOKI_CORE_REPEAT_4, LOKI_CORE_REPEAT_3, LOKI_CORE_REPEAT_2,              \
                      LOKI_CORE_REPEAT_1)                                                                          \
  (macro, __VA_ARGS__)
