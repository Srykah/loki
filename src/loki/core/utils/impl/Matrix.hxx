...
template <typename T>
template <typename Iterator, std::enable_if_t<std::is_lvalue_reference_v<typename std::iterator_traits<Iterator>::reference>, void>>
Matrix<T>::Matrix(std::size_t width, std::size_t height, Iterator iterator)
    : Matrix(width, height, [iterator]() mutable { return *iterator++; }) {
}

template <typename T>
template <typename Iterator, std::enable_if_t<std::is_rvalue_reference_v<typename std::iterator_traits<Iterator>::reference>, void>>
Matrix<T>::Matrix(std::size_t width, std::size_t height, Iterator iterator)
...
template <typename T>
constexpr std::size_t Matrix<T>::getWidth() const { return W; }

template <typename T>
constexpr std::size_t Matrix<T>::getHeight() const { return H; }

template <typename T>
auto Matrix<T>::begin() -> iterator { return data.begin(); }
...
template <typename T>
auto Matrix<T>::end() -> iterator { return data.end(); }

template <typename T>
auto Matrix<T>::end() const -> const_iterator { return data.cend(); }

template <typename T>
auto Matrix<T>::cend() const -> const_iterator { return data.cend(); }
...
template <typename T, std::size_t W, std::size_t H>
constexpr std::size_t StaticMatrix<T,W,H>::getWidth() const { return W; }

template <typename T, std::size_t W, std::size_t H>
constexpr std::size_t StaticMatrix<T,W,H>::getHeight() const { return H; }

template <typename T, std::size_t W, std::size_t H>
auto StaticMatrix<T,W,H>::begin() -> iterator { return data.begin(); }
...
template <typename T, std::size_t W, std::size_t H>
auto StaticMatrix<T,W,H>::end() -> iterator { return data.end(); }

template <typename T, std::size_t W, std::size_t H>
auto StaticMatrix<T,W,H>::end() const -> const_iterator { return data.cend(); }

template <typename T, std::size_t W, std::size_t H>
auto StaticMatrix<T,W,H>::cend() const -> const_iterator { return data.cend(); }
