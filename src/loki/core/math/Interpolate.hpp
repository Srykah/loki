...
class InterpolationBase {
 public:
  ...
  virtual Out operator()(const In& x) const final {
...
class NoneInterpolation : public InterpolationBase<In, Out> {
 public:
  ...
  explicit NoneInterpolation(Args&&... args) : points(std::forward<Args>(args)...) {}
...
class LinearInterpolation : public InterpolationBase<In, Out> {
 public:
  template <typename... Args>
  explicit LinearInterpolation(Args&&... args) : points(std::forward<Args>(args)...) {}
