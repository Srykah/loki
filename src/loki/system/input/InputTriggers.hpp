...
LOKI_REFLECTION_CLASS_BEGIN_RTTI_NO_FACTORY(loki::system::InputTrigger)
LOKI_REFLECTION_CLASS_END()
LOKI_RTTI_CLASS_DEFINE(loki::system::InputTrigger)

LOKI_REFLECTION_CLASS_BEGIN_CHILD(loki::system::KeyTrigger, loki::system::InputTrigger)
LOKI_REFLECTION_CLASS_FIELD(key)
LOKI_REFLECTION_CLASS_END()
LOKI_RTTI_CLASS_DEFINE(loki::system::KeyTrigger)

LOKI_REFLECTION_CLASS_BEGIN_CHILD(loki::system::MouseButtonTrigger, loki::system::InputTrigger)
LOKI_REFLECTION_CLASS_FIELD(button)
LOKI_REFLECTION_CLASS_END()
LOKI_RTTI_CLASS_DEFINE(loki::system::MouseButtonTrigger)

LOKI_REFLECTION_CLASS_BEGIN_CHILD(loki::system::JoystickAxisTrigger, loki::system::InputTrigger)
...
LOKI_REFLECTION_CLASS_BEGIN_CHILD(loki::system::JoystickButtonTrigger, loki::system::InputTrigger)
LOKI_REFLECTION_CLASS_FIELD(button)
LOKI_REFLECTION_CLASS_END()
