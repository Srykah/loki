...
class AbstractTextBox : public Widget, public sf::Drawable, public sf::Transformable {
 public:
  ~AbstractTextBox() override = default;

  virtual bool hasEnded() const = 0;
  virtual bool canFitInLine(const sf::String& string, unsigned int line) const = 0;
